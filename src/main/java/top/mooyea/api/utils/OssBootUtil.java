...
public class OssBootUtil {
    ...
    public static String upload(MultipartFile file, String fileDir,String customBucket) {
        ...
        if(OnConvertUtils.isNotEmpty(customBucket)){
        ...
        try {
            ...
            ossUrl = getString(fileDir, fileUrl, newBucket, fileName);
    ...
    private static String getString(String fileDir, StringBuilder fileUrl, String newBucket, String fileName) {
        String ossUrl;
        if (!fileDir.endsWith("/")) {
        ...
        if (OnConvertUtils.isNotEmpty(staticDomain) && staticDomain.toLowerCase().startsWith("http")) {
            ossUrl = staticDomain + "/" + fileUrl;
        } else {
            ossUrl = "https://" + newBucket + "." + endPoint + "/" + fileUrl;
        }
        return ossUrl;
    }
    ...
    public static String upload(FileItemStream file, String fileDir) {
        ...
        try {
            ...
            ossUrl = getString(fileDir, fileUrl, bucketName, fileName);
    ...
    public static void deleteUrl(String url,String bucket) {
        String newBucket = bucketName;
        if(OnConvertUtils.isNotEmpty(bucket)){
            newBucket = bucket;
        }
        String bucketUrl = "";
        if (OnConvertUtils.isNotEmpty(staticDomain) && staticDomain.toLowerCase().startsWith("http")) {
    ...
    public static String upload(InputStream stream, String relativePath) {
        ...
        initOss(endPoint, accessKeyId, accessKeySecret);
        if (OnConvertUtils.isNotEmpty(staticDomain) && staticDomain.toLowerCase().startsWith("http")) {
            ossUrl = staticDomain + "/" + relativePath;
        } else {
            ossUrl = "https://" + bucketName + "." + endPoint + "/" + relativePath;
        }
